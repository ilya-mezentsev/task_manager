...
cookieGroupLead="Cookie: TM-Session-Token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uIjoie1wiaWRcIjo4LFwibmFtZVwiOlwia2x5a292XCIsXCJyb2xlXCI6XCJncm91cF9sZWFkXCIsXCJncm91cF9pZFwiOjE0fSJ9.jzt6G3okN5wJVy9nXFEISQjBocXl8p75wTL-vnri9tgg"
#echo 'create group...'
...
curl localhost/api/group/lead/tasks -H "${cookieGroupLead}" -d '{"group_id": 14}'
